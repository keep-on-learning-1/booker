<?php
class BookIt extends PagePattern{
    ...
    function render(){
        $this->getHeader('Create event');
        ?>
        <?php echo $this->renderTopSection('Create event')?>
            ...
            <form id="create_event_form" action="index.php?action=create_event" method="POST">
                ...
                <p>
                    ...
                    <select name="event_month">
                        <?php for($i=0;$i<12;$i++):?>
                            <option value="<?php echo $i;?>" ><?php echo $this->months[$i]; ?></option>
                        <?php endfor;?>
                    </select>
                    ...
                    <select name="event_year">
                        <?php for($i=0;$i<2;$i++):?>
                            <option value="<?php echo $this->year + $i;?>" ><?php echo $this->year + $i;?></option>
                        <?php endfor;?>
                    </select>
                </p>
                <p>
                    ...
                    <br>
                    <?php if($this->config['booker']['time_format'] == '24h'):?>
                    ...
                    <?php elseif($this->config['booker']['time_format'] == '12h'):?>
                        <select  value="admin" name="start_hours">
                            <?php for($i=1; $i<=12; $i++):?>
                                <option value="<?php echo $i;?>" ><?php echo $i;?></option>
                            <?php endfor;?>
